...
use Amce\FilmBundle\Entity\Film;
use Amce\FilmBundle\Form\FilmType;
...
class FilmController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $dql = 'SELECT f FROM AmceFilmBundle:Film f';
        // $entities = $em->getRepository('AmceFilmBundle:Film')->findAll();
     ...
     * @Method("POST")
     * @Template("AmceFilmBundle:Film:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AmceFilmBundle:Film')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AmceFilmBundle:Film:edit.html.twig")
     */
